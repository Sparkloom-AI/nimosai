-- Drop the old problematic version of create_studio_with_data function
-- This version has 7 parameters and ambiguous column references
DROP FUNCTION IF EXISTS public.create_studio_with_data(
  studio_name text,
  studio_website text,
  studio_business_category_id uuid,
...
-- Ensure the new correct version exists with proper parameter prefixes
-- This function should already exist from previous migration but let's make sure it's correct
